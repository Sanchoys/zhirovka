...
- Added object deletion from the objects management screen.
- Added service listing, editing, and deletion controls in the tariffs section.

## [0.5.1] - 2026-04-26

### Fixed

- Fixed API failures on existing databases by applying compatible schema migrations at backend startup.
